...
class LoadImages {
	...
	LoadImages() throws IOException {
		  BufferedImage cardSheet = ImageIO.read(new File("C:\\Users\\Andy\\Documents\\NetBeansProjects\\Casino-en-Java\\Casino\\src\\main\\java\\Juegos\\BlackJack\\playing-cards.png"));
		  final int width = 73;
		  final int height= 98;
		  final int rows = 13;
		  final int columns = 4;
